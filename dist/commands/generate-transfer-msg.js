...
const generate_transfer_message_command_handler_1 = require("../handlers/generate-transfer-message.command-handler");
const generate_transfer_message_command_1 = require("../handlers/generate-transfer-message.command");
// Command definition
module.exports = {
...
const execute = async (interaction) => {
    let handler = new generate_transfer_message_command_handler_1.GenerateTransferMessageCommandHandler(new generate_transfer_message_command_1.GenerateTransferMessageCommand(interaction));
