...
const generate_transfer_message_handler_1 = require("../handlers/generate-transfer-message.handler");
...
module.exports = {
    ...
    async execute(interaction) {
        let command = new generate_transfer_message_command_1.GenerateTransferMessageCommand(interaction);
        let handler = new generate_transfer_message_handler_1.GenerateTransferMessageHandler(command);
